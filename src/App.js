  ...
  return (
    <div style={{ textAlign: "center", padding: 20 }}>
      ...
      <div style={{ marginTop: 20 }}>
        <div>
          <button onClick={() => handleButton("up")}>⬆️</button>
        </div>
        <div>
          <button onClick={() => handleButton("left")}>⬅️</button>
          <button onClick={() => handleButton("down")}>⬇️</button>
          <button onClick={() => handleButton("right")}>➡️</button>
        </div>
      </div>
    </div>
  );
